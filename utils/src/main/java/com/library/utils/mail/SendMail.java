...
//        props.setProperty("mail.smtp.auth", "true");
        ...
        props.setProperty("mail.smtp.host", "ismtp.beyondsoft.com");
        props.setProperty("mail.smtp.port", "25");
        props.setProperty("mail.user", "kefu@beyondsoft.com");
        props.setProperty("mail.password", "Bey0ndsoft2018");
        props.setProperty("mail.transport.protocol", "smtp");
        props.setProperty("maPil.smtp.starttls.enable", "true");
        props.setProperty("mail.smtp.auth", "true");
        ...
        try {
            ...
            transport.connect("kefu@beyondsoft.com", "Bey0ndsoft2018");
            ...
            msg.setFrom(new InternetAddress("kefu@beyondsoft.com"));

            Address[] addresses = new Address[]{new InternetAddress("liufeifei02@beyondsoft.com")};
