...
public class ThreadPoolConfig {
     ...
     * @Param []
     * @return com.library.utils.thread.pool.fac.ThreadPoolConfig
     * @author feifei.liu
    ...
    public static void setConfig(ThreadPoolConfig config) {
