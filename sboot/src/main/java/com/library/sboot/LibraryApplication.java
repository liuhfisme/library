...
@ComponentScan("com.library.sboot")
@EnableAutoConfiguration
@EnableTransactionManagement //开启声明式事务支持，自动扫描注解@Transactional
@EnableJpaRepositories(repositoryBaseClass = CustomRepositoryImpl.class,basePackages = {"com.library.sboot"})
