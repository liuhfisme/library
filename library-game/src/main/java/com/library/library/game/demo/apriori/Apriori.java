package com.library.library.game.demo.apriori;
...
public class Apriori {
	...
	// 扫描数据集，得出支持度以及项集
	public ArrayList<ArrayList<String>> scanData(
			ArrayList<ArrayList<String>> list,
			ArrayList<ArrayList<String>> data,
			ArrayList<ArrayList<String>> fcs, int n) {
	...
	// 连接步
	public ArrayList<ArrayList<String>> connection(
			ArrayList<ArrayList<String>> list, int n) {
		Iterator<ArrayList<String>> it = list.iterator();
		ArrayList<ArrayList<String>> css = new ArrayList<>();
	...
	// 剪枝步
	public ArrayList<ArrayList<String>> pruning(
			ArrayList<ArrayList<String>> list, ArrayList<ArrayList<String>> fcs) {
		ArrayList<ArrayList<String>> css = new ArrayList<>();
		ArrayList<String> line = new ArrayList<>();
		ArrayList<String> line1 = new ArrayList<>();
	...
	// 产生关联规则
	public void AssociationRules(ArrayList<ArrayList<String>> list,
			ArrayList<ArrayList<String>> data) {
		double confidence;
		Iterator<ArrayList<String>> it = list.iterator();
		ArrayList<ArrayList<String>> css = new ArrayList<>();
